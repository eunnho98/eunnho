    ...
    <Box>
      ...
      {isMdOrSmaller ? (
        ...
        >
          ...
          <VStack>
            <Text>
              캡스톤디자인으로 진행한 프로젝트입니다. AR 길찾기 서비스는
              실외에만 있고 실내에서는 찾아보기 힘들다는 것에 착안하여
              시작하였습니다.
            </Text>
            <Text>
              사용자가 로그인을 한 후 목적지를 입력하면 현재 위치에 관계없이
              실내외 통합 길찾기 서비스를 제공합니다. 또한 상대방이 자신의
              화면을 보는 것을 수락하면 화면 공유가 진행되고, 터치를 통하여
              상대방이 나에게 길을 안내해주는 기능도 구현하였습니다.
            </Text>
            <Text>
              평소 생소한 분야인 Unity에서 WebRTC를 통한 양방향 통신을 구현하는
              과정에서 여러 트러블슈팅이 있었지만 결국 해내었다는 점에서
              자신감을 가지게 되었습니다. 그리고 기존의 WebRTC 지식을 더욱
              확고히 다지는 계기가 되었습니다.
            </Text>
            <Text>
              또한 서로 다른 분야에 흥미가 있는 학생들이 모여 계속 대화를
              진행하며 결국 의미있는 결과를 내놓았다는 점에서 협업 능력과
              의사소통 능력도 향상되었습니다.
            </Text>
