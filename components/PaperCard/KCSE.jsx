      ...
      {isMdOrSmaller ? (
        <VStack mt="12px">
          ...
          <Text fontSize="14px" mt="12px">
            ...
            서비스를 이용하기도 한다. 이동 중에 스마트폰을 사용하면 사용자의
            신체 흔들림 등으로 사용자의 한 손 터치 정확도가 떨어지는 불편함이
            있다. 본 논문에서는 가속도 센서를 통해 측정되는 스마트폰의 기울어진
            정도를 기반으로 사용자가 터치하려는 버튼을 예측하는 CNN 모델을
            개발했다. 또한 예측된 버튼의 터치 허용 영역을 유연하게 확장하는 터치
            에러 감소 기법을 제시하고 실험을 통해 그 유용성에 대하여 검증했다.
          </Text>
        </VStack>
      ) : (
